...
<html>
 	...
 	<center>
		...
		<%
			...
			List<Entity> UploadImageEntities = datastore.prepare(ImageQuery).asList(FetchOptions.Builder.withLimit(5)); 
			// If we have no images there is nothing to display
			if (UploadImageEntities.isEmpty() == true) 
			{
		        %>
			...
			else 
			{
				...
				for (Entity UploadImage : UploadImageEntities)  
				{
